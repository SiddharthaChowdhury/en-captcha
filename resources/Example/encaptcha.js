...
function Encaptcha(user_input){
	...
	this.lap 			= parseInt(this.input.reload_sec);
	this.textboxsClass	= "";
...
Encaptcha.prototype.cookDomObjects = function(){
	...
	x.mike.setAttribute('style', 'text-align:center; padding: 5px 7px; cursor:wait;');
	x.mike.innerHTML = 'Valid for '+x.input.reload_sec+' sec';
	
	x.reload.setAttribute('style', 'cursor:pointer; text-decoration:none; float:right;');
